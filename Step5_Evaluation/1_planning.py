...
from Step5_Evaluation.model.diffusion import default_sample_fn
...
path = 'trained_model_worst/planner.pt'
data_path = 'data/sample_data.pkl'
goal_path = 'trained_model_worst/goal_model.pth'
